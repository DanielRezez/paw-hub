              ...
              children: [
                ...
                Expanded(
                  child: _buildAlertCard(
                    ...
                    title: 'Alertas',
                    alertText: 'Água baixa', // Este valor parece estático, o ViewModel poderia fornecer?
          ...
          Expanded(
            child: LineChart(
              LineChartData(
                ...
                titlesData: FlTitlesData(
                  leftTitles: const AxisTitles(
                    sideTitles: SideTitles(
                      showTitles: true,
                      reservedSize: 40,
                      interval: 80, // Ajuste conforme a necessidade dos seus dados
                    ),
                  ),
                ...
                maxX: 6,
                minY: 0,
                maxY: 320, // Ajuste o maxY conforme o máximo valor esperado de consumo
                lineBarsData: [
                  LineChartBarData(
                    spots: spots,
                    isCurved: false, // Ou true para curvas suaves
                    color: corPretoAzulado,
                    barWidth: 2,
